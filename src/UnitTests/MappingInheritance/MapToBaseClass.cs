...
public class ReverseMapAs : MahhalaMapperSpecBase
{
...
public class MapToBaseClass : MahhalaMapperSpecBase
{
    A _destination;
...
public class OverrideInclude : MahhalaMapperSpecBase
{
    class Source
    {
    }
...
public class IncludeAs : MahhalaMapperSpecBase
{
    class Source
    {
    }
