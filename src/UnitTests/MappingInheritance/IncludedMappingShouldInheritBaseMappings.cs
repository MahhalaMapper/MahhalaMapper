...
public class IncludeBaseIndirectBase : MahhalaMapperSpecBase
{
...
public class ReadonlyCollectionPropertiesOverride : MahhalaMapperSpecBase
{
...
public class ReadonlyCollectionProperties : MahhalaMapperSpecBase
{
    protected override MapperConfiguration CreateConfiguration() => new(cfg=>
    {
...
public class IncludedBaseMappingShouldInheritBaseMappings : NonValidatingSpecBase
{
    ...
    [Fact]
    public void include_should_allow_mahhalamapper_to_select_more_specific_included_type_with_one_parameter()
    {
        var config = new MapperConfiguration(cfg =>
        {
            cfg.CreateMap<ModelObject, DtoObject>()
    ...
    [Fact]
    public void include_should_allow_mahhalamapper_to_select_more_specific_included_type()
    {
        var config = new MapperConfiguration(cfg =>
        {
            cfg.CreateMap<ModelObject, DtoObject>()
