...
public class BuildExecutionPlan : MahhalaMapperSpecBase
{
    Model _source;
    Dto _destination;
    public class Model
...
public class When_reusing_the_execution_plan_inner_map : MahhalaMapperSpecBase
{
    class Source
    {
...
public class AllowNullWithMapAtRuntime : MahhalaMapperSpecBase
{
    class Source
    {
        public Inner Inner { get; set; }
...
public class When_reusing_the_execution_plan : MahhalaMapperSpecBase
{
    class Source
    {
...
public class When_reusing_the_execution_plan_existing_destination : MahhalaMapperSpecBase
{
    class Source
    {
        public int[] Ints { get; set; }
