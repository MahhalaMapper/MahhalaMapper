...
namespace MahhalaMapper.UnitTests.Tests;
...
public class When_using_a_custom_source_naming_convention : MahhalaMapperSpecBase
{
...
public class When_using_a_custom_destination_naming_convention : MahhalaMapperSpecBase
{
    private class Source
    {
