namespace MahhalaMapper.UnitTests.BidirectionalRelationships;

public class RecursiveMappingWithStruct : MahhalaMapperSpecBase
{
...
public class RecursiveDynamicMapping : MahhalaMapperSpecBase
{
...
public class When_mapping_to_a_destination_with_a_bidirectional_parent_one_to_many_child_relationship_using_CustomMapper_with_context : MahhalaMapperSpecBase
{
    private ParentDto _dto;
