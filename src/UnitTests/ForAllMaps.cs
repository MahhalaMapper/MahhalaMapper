...
public class ForAllMapsTypeConverter : MahhalaMapperSpecBase
{
...
public class ForAllMaps : MahhalaMapperSpecBase
{
...
public class ForAllMapsWithConstructors : MahhalaMapperSpecBase
{
    class Source
    {
    }
