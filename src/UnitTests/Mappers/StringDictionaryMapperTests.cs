...
public class When_mapping_from_StringDictionary_multiple_matching_keys : NonValidatingSpecBase
{
    ...
    {
        Should.Throw<MahhalaMapperMappingException>(() =>
        {
            Mapper.Map<Destination>(_source);
        }).InnerException.ShouldBeOfType<MahhalaMapperMappingException>().Types.ShouldBe(new TypePair(typeof(IDictionary<string, object>), typeof(Destination)));
    }
}
...
public class When_mapping_from_StringDictionary_to_existing_destination : MahhalaMapperSpecBase
{
...
public class When_mapping_from_StringDictionary_to_abstract_type : MahhalaMapperSpecBase
{
    public abstract class SomeBase
    {
        protected int _x = 100;
    ...
    public void Should_throw()
    {
        new Action(() => Mapper.Map<SomeBase>(new StringDictionary()))
            .ShouldThrowException<MahhalaMapperMappingException>(ex =>
