...
public class ShouldUseConstructorInternal : NonValidatingSpecBase
{
    ...
    [Fact]
    public void Should_only_map_internal_ctor() => Should.Throw<MahhalaMapperConfigurationException>(AssertConfigurationIsValid);
}
...
public class ShouldUseConstructorPrivate : NonValidatingSpecBase
{
    ...
    [Fact]
    public void Should_only_map_private_ctor() => Should.Throw<MahhalaMapperConfigurationException>(AssertConfigurationIsValid);
}
...
public class ShouldUseConstructorPublic : NonValidatingSpecBase
{
    ...
    {
        Should.Throw<MahhalaMapperConfigurationException>(AssertConfigurationIsValid);
    }
}

public class ShouldUseConstructorDefault : MahhalaMapperSpecBase
{
    class Destination
    {
        public Destination(int a, string b)
