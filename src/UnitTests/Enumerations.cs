...
using MahhalaMapper.UnitTests;
namespace MahhalaMapper.Tests;
public class CreateProjectionEnum : MahhalaMapperSpecBase
{
    public class Source
    {
...
public class InvalidStringToEnum : MahhalaMapperSpecBase
{
    protected override MapperConfiguration CreateConfiguration() => new(_=> { });
    [Fact]
    public void Should_throw() => new Action(()=>Map<ConsoleColor>("d")).ShouldThrow<MahhalaMapperMappingException>().InnerException.Message.ShouldBe(
        "Requested value 'd' was not found.");
}
public class DefaultEnumValueToString : MahhalaMapperSpecBase
{
...
public class StringToNullableEnum : MahhalaMapperSpecBase
{
    Destination _destination;
...
public class NullableEnumToString : MahhalaMapperSpecBase
{
    Destination _destination;
...
public class When_mapping_from_a_null_object_with_an_enum : MahhalaMapperSpecBase
{
    protected override MapperConfiguration CreateConfiguration() => new(cfg =>
    {
...
public class When_mapping_to_a_nullable_flags_enum : MahhalaMapperSpecBase
{
    protected override MapperConfiguration CreateConfiguration() => new(cfg =>
    {
        cfg.CreateMap<SourceClass, DestinationClass>();
...
public class When_mapping_from_a_null_object_with_a_nullable_enum : MahhalaMapperSpecBase
{
    protected override MapperConfiguration CreateConfiguration() => new(cfg =>
    {
        cfg.AllowNullDestinationValues = false;
...
public class When_mapping_from_a_null_object_with_a_nullable_enum_as_string : MahhalaMapperSpecBase
{
    protected override MapperConfiguration CreateConfiguration() => new(cfg =>
    {
        cfg.CreateMap<SourceClass, DestinationClass>();
...
public class When_the_target_has_an_enummemberattribute_value : MahhalaMapperSpecBase
{
...
public class When_the_source_has_an_enummemberattribute_value : MahhalaMapperSpecBase
{
    public enum EnumWithEnumMemberAttribute
    {
        Null,
