...
public class When_an_extension_methods_contraints_fail : NonValidatingSpecBase
{
    ...
    [Fact]
    public void It_should_fail_validation() => new Action(AssertConfigurationIsValid).ShouldThrow<MahhalaMapperConfigurationException>()
        .Errors[0].UnmappedPropertyNames[0].ShouldBe(nameof(Destination.Count));
}
public class When_an_extension_method_is_for_a_base_interface : MahhalaMapperSpecBase
{
    class Source : IGeneric<int>
    {
    }
...
public class When_an_extension_method_is_for_a_base_class : MahhalaMapperSpecBase
{
    class Source
    {
    }
...
public class When_null_is_passed_to_an_extension_method : MahhalaMapperSpecBase
{
    public class Foo
    {
...
public class When_extension_method_returns_value_type : MahhalaMapperSpecBase
{
...
public class When_extension_method_returns_object : MahhalaMapperSpecBase
{
    private Destination _destination;
...
public class When_extension_contains_LINQ_methods : MahhalaMapperSpecBase
{
    private Destination _destination;
...
public class When_disabling_method_maping : NonValidatingSpecBase
{
    ...
    {
        new Action(AssertConfigurationIsValid).ShouldThrow<MahhalaMapperConfigurationException>().Errors[0]
...
public class When_a_static_method_has_first_parameter_null : MahhalaMapperSpecBase
{
    class FirstName
    {
        public string Name;
