namespace MahhalaMapper.UnitTests.Projection.MapFromTest;
...
public class When_mapping_from_and_source_member_both_can_work : MahhalaMapperSpecBase
{
    Dto _destination;
...
public class When_mapping_from_chained_properties : MahhalaMapperSpecBase
{
    class Model
    {
...
public class When_mapping_from_private_method : MahhalaMapperSpecBase
{
    class Model
    {
        public InnerModel Inner { get; set; }
