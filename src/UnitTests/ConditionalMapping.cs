namespace MahhalaMapper.UnitTests.ConditionalMapping;

public class When_adding_a_condition_for_all_members : MahhalaMapperSpecBase
{
...
public class When_ignoring_all_properties_with_an_inaccessible_setter_and_explicitly_implemented_member : MahhalaMapperSpecBase
{
...
public class When_configuring_a_member_to_skip_based_on_the_property_value : MahhalaMapperSpecBase
{
    public class Source
    {
        public int Value { get; set; }
...
public class When_configuring_a_member_to_skip_based_on_the_property_value_with_custom_mapping : MahhalaMapperSpecBase
{
    public class Source
    {
        public int Value { get; set; }
...
public class When_configuring_a_map_to_ignore_all_properties_with_an_inaccessible_setter : MahhalaMapperSpecBase
{
...
public class When_configuring_a_reverse_map_to_ignore_all_source_properties_with_an_inaccessible_setter : MahhalaMapperSpecBase
{
    private Destination _destination;
