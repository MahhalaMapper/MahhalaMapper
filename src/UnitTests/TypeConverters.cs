namespace MahhalaMapper.UnitTests.CustomMapping;
public class StringToEnumConverter : MahhalaMapperSpecBase
{
    class Source
    {
...
public class NullableConverter : MahhalaMapperSpecBase
{
...
public class MissingConverter : MahhalaMapperSpecBase
{
    protected override MapperConfiguration CreateConfiguration() => new(c =>
    {
    ...
    public void Should_report_the_missing_converter()
    {
        new Action(()=>Mapper.Map<int, int>(0))
            .ShouldThrowException<MahhalaMapperMappingException>(e=>e.Message.ShouldBe("Cannot create an instance of type MahhalaMapper.ITypeConverter`2[System.Int32,System.Int32]"));
    }
}

public class DecimalAndNullableDecimal : MahhalaMapperSpecBase
{
...
public class When_converting_to_string : MahhalaMapperSpecBase
{
    Destination _destination;
...
public class When_specifying_type_converters_for_object_mapper_types : MahhalaMapperSpecBase
{
    class Source
    {
...
public class When_specifying_type_converters : MahhalaMapperSpecBase
{
    ...
    protected override void Because_of()
    {
        var source = new Source
        {
            Value1 = "5",
            Value2 = "01/01/2000",
            Value3 = "MahhalaMapper.UnitTests.CustomMapping.When_specifying_type_converters+Destination"
        };
...
public class When_specifying_type_converters_on_types_with_incompatible_members : MahhalaMapperSpecBase
{
...
public class When_specifying_a_non_generic_type_converter_for_a_non_generic_configuration : MahhalaMapperSpecBase
{
    private Destination _result;
