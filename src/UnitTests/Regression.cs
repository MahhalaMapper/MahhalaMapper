namespace MahhalaMapper.UnitTests
{
    namespace Regression
    {
        ...
        public class mahhalamapper_fails_to_map_custom_mappings_when_mapping_collections_for_an_interface : MahhalaMapperSpecBase
        {
        ...
        public class Chris_bennages_nullable_datetime_issue : MahhalaMapperSpecBase
        {
        ...
        public class TestEnumerable : MahhalaMapperSpecBase
        {
            protected override MapperConfiguration CreateConfiguration() => new(cfg =>
            {
