using MahhalaMapper.Configuration.Annotations;
...
namespace MahhalaMapper.UnitTests
{
    namespace AttributeBasedMaps
    {
        public class When_specifying_map_with_attribute : NonValidatingSpecBase
        {
            ...
            {
                typeof(MahhalaMapperConfigurationException).ShouldNotBeThrownBy(() => AssertConfigurationIsValid<Source, Dest>());
            }
        }
        ...
        public class When_specifying_map_and_reverse_map_with_attribute : NonValidatingSpecBase
        {
            ...
            {
                typeof(MahhalaMapperConfigurationException).ShouldNotBeThrownBy(() => AssertConfigurationIsValid<Source, Dest>());
                typeof(MahhalaMapperConfigurationException).ShouldNotBeThrownBy(() => AssertConfigurationIsValid<Dest, Source>());
            }
        }
        ...
        public class When_specifying_reverse_map_with_sourcemember_attribute : NonValidatingSpecBase
        {
            ...
            public void Should_validate_successfully()
            {
                typeof(MahhalaMapperConfigurationException).ShouldNotBeThrownBy(() => AssertConfigurationIsValid<Source, Destination>());
                typeof(MahhalaMapperConfigurationException).ShouldNotBeThrownBy(() => AssertConfigurationIsValid<Destination, Source>());
            }
        }
        ...
        public class When_specifying_generic_reverse_map_with_sourcemember_attribute : NonValidatingSpecBase
        {
            ...
            public void Should_validate_successfully()
            {
                typeof(MahhalaMapperConfigurationException).ShouldNotBeThrownBy(() => AssertConfigurationIsValid(typeof(Source<>), typeof(Destination<>)));
                typeof(MahhalaMapperConfigurationException).ShouldNotBeThrownBy(() => AssertConfigurationIsValid(typeof(Destination<>), typeof(Source<>)));
            }
        }
        ...
        public class When_specifying_map_with__multiple_attribute_sources : NonValidatingSpecBase
        {
            ...
            public void Should_validate_successfully()
            {
                typeof(MahhalaMapperConfigurationException).ShouldNotBeThrownBy(() => AssertConfigurationIsValid<FirstSource, Dest>());
                typeof(MahhalaMapperConfigurationException).ShouldNotBeThrownBy(() => AssertConfigurationIsValid<SecondSource, Dest>());
            }
        }
        ...
        public class When_not_specifying_as_proxy_via_attribute : NonValidatingSpecBase
        {
            ...
            {
                var source = new Source { Value = 15 };
                Should.Throw<MahhalaMapperMappingException>(() => Mapper.Map<IDest>(source))
