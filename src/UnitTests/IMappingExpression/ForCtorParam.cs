...
public class ForCtorParamValidation : MahhalaMapperSpecBase
{
...
public class ForCtorParam_MapFrom_String : MahhalaMapperSpecBase
{
...
public class ForCtorParam_MapFrom_ProjectTo : MahhalaMapperSpecBase
{
    public class Source
    {
...
public class When_configuring__non_generic_ctor_param_members : MahhalaMapperSpecBase
{
    public class Source
    {
    ...
    public void Should_throw_on_nonexistent_parameter()
    {
        ...
        configuration.ShouldThrowException<MahhalaMapperConfigurationException>(exception =>
        {
