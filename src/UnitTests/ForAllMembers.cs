namespace MahhalaMapper.UnitTests.ForAllMembers;
public class When_conditionally_applying_a_resolver_globally : MahhalaMapperSpecBase
{
    public class Source
    {
...
public class When_conditionally_applying_a_resolver_per_profile : MahhalaMapperSpecBase
{
    public class Source
    {
        public DateTime SomeDate { get; set; }
...
public class ForAllPropertyMaps_ConvertUsing : MahhalaMapperSpecBase
{
    public class Well
    {
