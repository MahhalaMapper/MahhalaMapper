...
public class ForPathGenericsSource : MahhalaMapperSpecBase
{
    class Source<T>
    {
...
public class ForPathGenerics : MahhalaMapperSpecBase
{
    class Source<T>
    {
        public InnerSource Inner;
...
public class ReadonlyPropertiesGenerics : MahhalaMapperSpecBase
{
    class Source
    {
        public InnerSource Inner;
...
public class ConstructorValidationGenerics : NonValidatingSpecBase
{
    ...
    {
        var error = new Action(AssertConfigurationIsValid).ShouldThrow<MahhalaMapperConfigurationException>().Errors.Single();
        error.CanConstruct.ShouldBeFalse();
        error.UnmappedPropertyNames.Single().ShouldBe("OtherValue");
    }
}
public class SealGenerics : MahhalaMapperSpecBase
{
...
public class OpenGenerics_With_Struct : MahhalaMapperSpecBase
{
    public struct Id<T>
    {
    }
...
public class OpenGenerics_With_Base_Generic : MahhalaMapperSpecBase
{
    public class Foo<T>
    {
...
public class GenericMapsAsNonGeneric : MahhalaMapperSpecBase
{
    class Source
    {
        public int Value;
...
public class GenericMapsPriority : MahhalaMapperSpecBase
{
    class Source<T>
    {
        public T Value;
...
public class GenericMapWithUntypedMap : MahhalaMapperSpecBase
{
    class Source<T>
    {
        public T Value;
...
public class GenericValueResolverTypeMismatch : MahhalaMapperSpecBase
{
    class Source<T>
    {
        public T Value;
...
public class GenericValueResolver : MahhalaMapperSpecBase
{
    class Destination
    {
        public string MyKey;
...
public class GenericMemberValueResolver : MahhalaMapperSpecBase
{
    class Destination
    {
        public string MyKey;
...
public class RecursiveOpenGenerics : MahhalaMapperSpecBase
{
...
public class OpenGenericsValidation : NonValidatingSpecBase
{
    ...
    public void Should_report_unmapped_property()
    {
        new Action(Configuration.AssertConfigurationIsValid)
            .ShouldThrow<MahhalaMapperConfigurationException>()
...
public class OpenGenericsProfileValidation : MahhalaMapperSpecBase
{
    public class Source<T>
    {
        public T[] Value { get; set; }
...
public class OpenGenerics_With_MemberConfiguration : MahhalaMapperSpecBase
{
    public class Foo<T>
    {
        public int A { get; set; }
...
public class OpenGenerics_With_UntypedMapFrom : MahhalaMapperSpecBase
{
    public class Foo<T>
    {
        public T Value1 { get; set; }
...
public class OpenGenerics_With_UntypedMapFromStructs : MahhalaMapperSpecBase
{
