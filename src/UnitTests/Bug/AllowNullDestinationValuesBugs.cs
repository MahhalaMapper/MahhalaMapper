...
public class When_mapping_to_an_assignable_object_with_nullable_off : MahhalaMapperSpecBase
{
...
public class When_AllowNullDestinationValues_is_false : MahhalaMapperSpecBase
{
    public class Source
    {
    }
