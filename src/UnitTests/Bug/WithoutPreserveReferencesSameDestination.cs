...
public class Self_referencing_existing_destination_without_PreserveReferences : MahhalaMapperSpecBase
{
...
public class WithoutPreserveReferencesSameDestination : MahhalaMapperSpecBase
{
    public class DtoOne
    {
