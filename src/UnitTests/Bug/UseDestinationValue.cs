...
public class UseDestinationValueNullable : MahhalaMapperSpecBase
{
    class Source
    {
        public int? Value;
...
public class UseDestinationValue : MahhalaMapperSpecBase
{
...
public class DontUseDestinationValue : NonValidatingSpecBase
{
    ...
    public void Should_report_missing_constructor()
    {
        ...
        new Action(()=>Mapper.Map<Organization>(orgDto)).ShouldThrowException<MahhalaMapperMappingException>(
