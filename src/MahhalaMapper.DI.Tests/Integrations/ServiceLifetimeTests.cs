...
namespace MahhalaMapper.Extensions.Microsoft.DependencyInjection.Tests.Integrations
{
	public class ServiceLifetimeTests
	{
		...
		public void CanUseDefaultInjectedIMapperInSingletonService()
		{
			...
			services.AddMahhalaMapper(cfg => cfg.CreateMap<Foo, Bar>().ReverseMap(), GetType().Assembly);
