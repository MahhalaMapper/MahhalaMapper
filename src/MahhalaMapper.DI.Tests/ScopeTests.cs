...
namespace MahhalaMapper.Extensions.Microsoft.DependencyInjection.Tests
{
    public class ScopeTests
    {
        ...
        public void Can_depend_on_scoped_services_as_transient_default()
        {
            ...
            services.AddMahhalaMapper(new [] { typeof(Source).Assembly });
        ...
        {
            var services = new ServiceCollection();
            services.AddMahhalaMapper(new [] { typeof(Source).Assembly }, ServiceLifetime.Scoped);
            services.AddScoped<ISomeService, MutableService>();
        ...
        {
            var services = new ServiceCollection();
            services.AddMahhalaMapper(new [] { typeof(Source).Assembly }, ServiceLifetime.Singleton);
            services.AddScoped<ISomeService, MutableService>();
